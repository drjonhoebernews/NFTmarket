# Generated by Django 4.1.7 on 2023-03-14 19:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(to='nftprod.category')),
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nftprod.collection')),
                ('creater', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nft_creater', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Property',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nft', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ownerships', to='nftprod.nft')),
